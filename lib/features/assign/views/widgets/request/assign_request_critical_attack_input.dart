...
class AssignReqCriticalAttackInputScreen extends ConsumerWidget {
  AssignReqCriticalAttackInputScreen({
    super.key,
  });
          ...
          child: Column(
            ...
            children: [
              ...
              index == 5
                  ...
                  : TextFormField(
                      decoration: getInputDecoration(_labelTitlesHint[index]),
