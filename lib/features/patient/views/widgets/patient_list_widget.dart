...
Widget patientListWidget(BuildContext context, WidgetRef ref, bool isMyGroup,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                radioButton(ref, '내조직', '전체', isMyGroup, 11,
                                    changeGroup),
                                Gaps.h10,
                                const Expanded(
                                  flex: 32,
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => GestureDetector(
                          onTap: () async {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => PatientDetailScreen(patient: patient.items[index]))
                            );
            ...
            child: BottomPositionedSubmitButton(
                ...
                function: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const PatientRegScreen(patient: null),
                    ),
                  );
                }),
          ),
