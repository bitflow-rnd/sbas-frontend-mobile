...
class PatientDiseaseInfoModel {
  ...
  factory PatientDiseaseInfoModel.fromJson(Map<String, dynamic> json) => PatientDiseaseInfoModel(
    ...
    ptCatg: json["ptCatg"],
    rmk: json["rmk"],
    undrDsesNms: List<String>.from(json["undrDsesNms"].map((x) => x)),
    ptTypeNms: List<String>.from(json["ptTypeNms"].map((x) => x)),
    svrtTypeNms: List<String>.from(json["svrtTypeNms"].map((x) => x)),
    bdtp: json["bdtp"],
    hr: json["hr"],
    resp: json["resp"],
    spo2: json["spo2"],
